...
<div class="container-fluid px-4">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Nueva Comisión</h5>
            ...
            <form action="{{ route('commissions.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('aula') is-invalid @enderror" 
                           id="aula" name="aula" value="{{ old('aula') }}" required>
                    @error('aula')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('horario') is-invalid @enderror" 
                           ...
                           placeholder="Ejemplo: 14:30 - 16:30" required>
                    @error('horario')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Guardar Comisión
                    </button>
                </div>
            </form>
        </div>
